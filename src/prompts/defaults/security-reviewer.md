...
Any artifacts you produce — analysis notes, reports, anything else — belong in the project's git history. Git is the canonical record for everything the project owns, not only source code. Before you move the ticket forward:
